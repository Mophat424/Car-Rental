...
//   // Truncate all tables to clear existing data and reset IDs
//   await db.execute("TRUNCATE TABLE customer, locations, car, reservation, bookings, payment, maintenance, insurance RESTART IDENTITY CASCADE;");
//   console.log("Tables truncated successfully.");

//   // Insert locations (ensure contactNumber is provided for notNull)
//   await db.insert(LocationTable).values([
//     { locationName: "Nairobi", address: "123 Nairobi", contactNumber: "1234567890" },
//     { locationName: "Eldoret", address: "Eldoret", contactNumber: "0987654321" },
//     { locationName: "Nakuru", address: "789 Nakuru", contactNumber: "5555555555" },
...
async function seed() {
  ...
  await db.execute(
    "TRUNCATE TABLE customer, locations, car, reservation, bookings, payment, maintenance, insurance, users RESTART IDENTITY CASCADE;"
  );
  console.log("Tables truncated successfully.");
  ...
  // Insert customers using user IDs
  await db.insert(CustomerTable).values([
    {
      userID: users[0][0].id,
      firstName: "John",
